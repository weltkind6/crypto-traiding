...
const Future = () => {
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.flexContainer}>
                <div className={styles.descTopContainer}>
                    ...
                    <p className={styles.text}>
                        Take advantage of time and sales, futures spread orders and depth trader — plus, trade directly
                        from
                        charts.
                    </p>
                ...
                <div className={styles.blockContainer}>
                    ...
                    <div className={styles.bottomBacking}/>
            ...
            <div className={styles.futureBall}/>
            <div className={styles.futureBall2}/>
        </div>
    );
};
